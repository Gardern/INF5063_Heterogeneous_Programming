...
int16_t outY[352*288] __attribute__ ((aligned(16)));
int16_t outU[176*144] __attribute__ ((aligned(16)));
int16_t outV[176*144] __attribute__ ((aligned(16)));
...
struct frame
{
  ...
  yuv_t *newOrig;	  // Original input image
  yuv_t *recons;      // Reconstructed image
  yuv_t *newRecons;   // Reconstructed image
...
struct c63_common
{
  ...
  uint8_t quanttbl[3][64] __attribute__((aligned(16)));
